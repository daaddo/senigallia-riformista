...
export const councilCandidates = [
  ...
  },
  {
    ...
    bio: "Laureata in Fisica a Bologna nel 1965, e' stato ricercatore presso l'Universita' di Bari e poi di Bologna, dove e' diventato professore associato e, dal 1987, ordinario di Fisica Matematica. Ricercatore attivo anche all'estero (CEA, CERN), ha operato nel settore dei sistemi complessi, compresa la mobilita' urbana. Ha coordinato progetti di ricerca italiani ed europei e organizzato convegni internazionali. Attualmente e' impegnato nella promozione della cultura scientifica attraverso incontri su temi di rilevanza sociale quali il cambiamento climatico e la transizione energetica.",
    imageUrl: null,
